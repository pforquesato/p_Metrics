...
if __name__ == '__main__':
    ...
    t1 = p_OLS.p_OLS(df, yv, xv, autoPrint=False)
    t2 = p_OLS.p_OLS(df, yv, xv[0:3], autoPrint=False)
    t3 = p_OLS.p_OLS(df, yv, xv[0:2], autoPrint=False)
    t4 = p_IV.p_IV(df, yv, ['factor:YEAR'], ['x_rich', 'x_poorcl'], ['nbx_rich', 'nbx_poorcl'], autoPrint=False)
    t5 = p_FE.p_FE(df, yv, xv[0:2], indexes=['VTD', 'YEAR'], autoPrint=False)
